...
<Steps>
  <Step title="Create a project">
    Sign in to [app.failpath.dev](https://app.failpath.dev) and create a new project. Once the project is created, copy your project key — it looks like `fp_project_xxx`. You'll use it in the next step to connect your repository.
  </Step>
