...
<Steps>
  <Step title="Create a project in the Failpath dashboard">
    Sign in to [app.failpath.dev](https://app.failpath.dev) and create a new project. Once it's created, copy your project key — it looks like `fp_project_xxx` and is the only credential you need to connect your repository.
  </Step>
